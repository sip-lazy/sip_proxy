...
credentials         = "Digest"i LWS digest_cln (COMMA dig_resp)*

dig_resp          =  username / realm / nonce / digest_uri / dresponse / algorithm 
                      / cnonce / opaque / message_qop / nonce_count / auth_param
                      
username          = "username"i EQUAL quoted_string

digest_uri        = "uri"i EQUAL quoted_string

dresponse         = "response"i EQUAL quoted_string

cnonce            = "cnonce"i EQUAL nonce_value

message_qop       = "qop"i EQUAL qop_value

nonce_count       = "nc"i EQUAL LHEX +
...
response_port     = "rport"i rport: ( EQUAL rport )?

rport             = rport: (DIGIT ? DIGIT ? DIGIT ? DIGIT ? DIGIT ?) {
